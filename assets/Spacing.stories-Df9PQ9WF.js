const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Spacing-BZDD47Ir.js","assets/vue-CcDDCeEj.js","assets/Dropdown-C1iBmCIB.js","assets/_plugin-vue_export-helper-DlAUqK2U.js","assets/Dropdown-C1vN5-Xk.css","assets/Input-BefHb41S.js","assets/Input-BhOEFvjh.css","assets/Spacing-D7psWDL2.css"])))=>i.map(i=>d[i]);
import{_ as p}from"./storybook-CGE4UHPU.js";import{d,b as i}from"./vue-CcDDCeEj.js";const a=d(()=>p(()=>import("./Spacing-BZDD47Ir.js"),__vite__mapDeps([0,1,2,3,4,5,6,7]))),m={title:"Components/Spacing",component:a,tags:["autodocs"],argTypes:{value:{control:"object",description:'Object with margin and padding. Example: { margin: { top: "12px", bottom: "auto", right: "auto", left: "auto" }, padding: { top: "12%", bottom: "12%", right: "12%", left: "12%" } }'},defaultValue:{control:"object",description:"Default values for margin and padding if value is empty"},customOptions:{control:"object",description:"Array of custom dropdown options"},disableSuggestion:{control:"object",description:"Disable suggestions dropdown for margin and padding"},readOnlyFields:{control:"object",description:"Make the input-field read-only"}}},r=o=>({components:{Spacing:a},setup(){const e=i(null);return{args:o,updatedItem:e,onUpdate:n=>{e.value=n}}},template:`
